...
function createPrompt(question, playerAnswers) {
    ...
    return `
      ...
      3. Твой ответ должен сливаться с толпой. Если они пишут коротко и с маленькой буквы — делай так же. Если пишут с большой буквы - пиши тоже с большой буквы. Если они шутят абсурдно — шути так же.
